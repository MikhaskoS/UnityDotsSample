...
// Системы могут планировать работу для выполнения в рабочих потоках.
// Однако создание и удаление сущностей может быть выполнено только в главном потоке
// Система использует EntityCommandBuffer для отложения задач, которые не могут быть выполнены внутри Job.
// -- Это нужно для спавна больших систем
