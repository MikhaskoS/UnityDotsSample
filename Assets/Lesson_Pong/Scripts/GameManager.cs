...
// https://www.youtube.com/watch?v=a9AUXNFBWt4&feature=youtu.be
public class GameManager : MonoBehaviour
{
	...
	void SpawnBall()
	{
		...
		Vector3 dir = new Vector3(UnityEngine.Random.Range(0, 2) == 0 ? -1 : 1, 
			UnityEngine.Random.Range(-.5f, .5f), 0f).normalized;
